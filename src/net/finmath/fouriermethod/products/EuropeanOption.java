 ...
 * @version 1.0
 */
public class EuropeanOption extends AbstractProductFourierTransform implements ProductInterface {
	...
	@Override
	public Double getValue(ModelInterface model) {
		Double value = null;
		try {
	...
	@Override
	public Map<String, Object> getValues(ModelInterface model) {
