...
public class CapletCalibration20190502FullMaturities {
	public static void main(String[] args) throws SolverException, CloneNotSupportedException {
		 ...
		 */
		double b = 0.05769718466962348;//0.3;
		double sigma = 0.015789007994048317;//0.5;
		double eta =  0.05918343595932772;//0.5;
		double zeta = 0.06918343595932772;//0.2;
		double alpha = 1.6979723707482892;//1.8;
		double[] initialValues = {0.0010256627870067618, 0.00198606411515568};
		double[] immigrationRates = {0.001, 0.003};
		...
		ScalarParameterInformationInterface[] initialValuesInfo = 
			{new ScalarParameterInformation(true, new BoundConstraint(1E-5, 1E-4)),
					new ScalarParameterInformation(true, new BoundConstraint(1.1*1E-4, 3* 1E-3))};
