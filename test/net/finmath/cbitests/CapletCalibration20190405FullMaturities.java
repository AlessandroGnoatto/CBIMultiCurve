...
public class CapletCalibration20190405FullMaturities {
	public static void main(String[] args) throws SolverException, CloneNotSupportedException {
		...
		double zeta = 0.2;
		double alpha = 1.8;
		double[] initialValues = {0.0012256627870067618, 0.0148606411515568};
		...
		MultivariateCalibrableProcessInterface newModel = result.getModel();
